...
namespace KhTracker
{
    public class Codes
    {
        ...
        {
            {"Armor Xemnas I", "Armor Xemnas I"},
            {"Armor Xemnas II", "Armor Xemnas II"},
            {"Axel (Data)", "DataAxel"},
            {"Axel I", "Axel1"},
            {"Axel II", "Axel"},
            {"Barbossa", "Barbossa"},
            {"Blizzard Lord", "Blizzard Lord"},
            {"Blizzard Lord (Cups)", "Blizzard Lord (Cups)"},
            {"Boat Pete", "BoatPete"},
            {"Cerberus", "Cerberus"},
            {"Cerberus (Cups)", "Cerberus (Cups)"},
            {"Cloud", "Cloud"},
            {"Cloud (1)", "Cloud (1)"},
            {"Cloud (2)", "Cloud (2)"},
            ...
            {"Vivi", "Vivi"},
            {"Volcano Lord", "Volcano Lord"},
            {"Volcano Lord (Cups)", "Volcano Lord (Cups)"},
            {"Xaldin", "Xaldin"},
